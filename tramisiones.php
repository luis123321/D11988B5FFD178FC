                ...
                <nav class="mainmenu">
                    <div class="container">
                        ...
                        <ul class="sf-menu" id="menu">
                            ...
                            <li class="current">
                                <a href="about.html">Resultados</a>
                            ...
                            <li>
                                <a href="#">Transmisiones</a>
                                <div class="sf-mega">
                                   <div class="col-md-3">
                                        <h4>Trasmisiones en VIVO</h4>
                                        <div class="in_live">
                                            <!--<img class="vivo" src="img/blog/envivo.png"> -->
                                            <p class="text-live">"Aquí en Youloteria tenemos todo lo que necesitas, sobre todo tenemos todas las trasmisiones en vivo de las loterías dominicanas . ¿Te perdiste de una ? ¡También ofrecemos en nuestro canal de todas las loterías grabadas exactamente en directo!"</p>

                                       </div>

                                        <!--<ul>                                                
                                            <li><a href="sports.html">Canal </a></li>
                                    ...
                                    <div class="col-md-3">
                                      <h4>Loteria Nacional</h4>
                                      <div class="img-hover">
                                         <img src="img/blog/1.jpg" alt="" class="img-responsive">
                                         <div class="overlay"><a href="sports.html">NACIONAL</a></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="img-hover">
                                         ...
                                         <div class="overlay"><a href="sports.html">LEIDSA</a></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="img-hover">
                                         ...
                                         <div class="overlay"><a href="sports.html">REAL</a></div>
                                      </div>
                            ...
                            <li class="current">
                                 <a href="gallery-4-columns.html">Internacionales</a>
                                <ul class="sub-current">
                                    <li>
                ...
                <section class="container">
                    <div class="row padding-top">  
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel-box">
                                <div class="titles">
                                    <h4><i class="fa fa-youtube-play"></i>Loteria Nacional</h4>
                                </div>
                                <!-- Accorodion Faq --> 
                                <div class="row">
                                    <div class="accrodation">
                                        <!-- section 1 -->
                                        <span class="acc-trigger"><a href="#">Trasmisión en Vivo</a></span>
                                        <div class="acc-container" style="display: none;">
                                            <div class="content">
                                                <div class="lt-inlive">
                                                    <embed src='http://certv.gob.do/institucional/live/canal4/reproductor/player.swf' height='1139' width='1139' allowscriptaccess='always' allowfullscreen='true' flashvars="&autostart=true&controlbar=over&file=canal4&plugins=viral-2d&streamer=rtmp%3A%2F%2F216.24.196.40%3A1935%2Flive"/>
                                                </div>
                                            </div>
                                        </div>
                                                                                                                           
                                        <!-- section 6 -->
                                        <span class="acc-trigger"><a href="#">¡Información sobre la Lotería Nacional!</a></span>
